...
import type { StorageInput, StorageMetadata, StorageObject } from "./types";

/**
 * Default implementation of StorageObject.
 * Wraps binary data with convenient accessor methods.
 */
export class BaseStorageObject implements StorageObject {
  constructor(
 ...
 */
export async function toBytes(input: StorageInput): Promise<Uint8Array> {
